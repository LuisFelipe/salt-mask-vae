...
from layers import EncoderBlockV2, DecoderBlockV2
...
class Vae(flow.Model):
    ...
    def init_layers(self):
        ...
        self.encoder = EncoderBlockV2(
            filters=128, activation="relu",
            kernel_initializer="he_normal", n_latent=4,
            name=None,
        )

        self.decoder = DecoderBlockV2(
            filters=128, activation="relu",
    ...
    def sample(self):
        ...
        # x_hat = self.decoder(self.outputs.z)
        x_hat = self.decoder(z) 
    ...
    def get_loss_and_metrics(self, _inputs):
        ...
        _loss = tf.reduce_mean(mse + kl_loss, name="loss")
